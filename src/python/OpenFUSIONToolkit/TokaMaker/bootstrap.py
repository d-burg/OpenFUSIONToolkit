...
def solve_with_bootstrap(mygs,
    ...
    if inductive_jphi is not None:
        ...
        # Ip-scale secant removed: the solver now holds Ip to target
        # natively (jphi-linterp cut-cell fix + Ip outer loop in the gs
        # solve), so rescaling Ip_target here is redundant.  The core-j0
        # secant above is retained.
        final_scale_Ip = 1.0
